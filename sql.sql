...
-- A despejar dados para tabela iptvplanner.users: ~1 rows (aproximadamente)
DELETE FROM `users`;
INSERT INTO `users` (`users_id`, `email`, `password`, `permission_id`, `valid`, `nome`, `apelido`, `data_nascimento`, `telefone`, `avatar_path`) VALUES
	(1, 'teixeira.nuno88@gmail.com', '1234', 3, 1, 'Nuno', 'Teixeira', '1988-08-27', '+351917737010', 'images/123.png');
